...
def treeviewEmployeeUpdate():
	...
	for i in myresults:
		print(i[3])
		EmployView.insert("","end",tags=(i[3]),text="",values=(i[0],i[1],i[2],i[3],i[4]))
...
#Tags
EmployView.tag_configure("Frycook", background="misty rose",font=("Georgia",10))
EmployView.tag_configure("Register", background="light blue",font=("Comic Sans MS",10))
EmployView.tag_configure("Waiter", background="yellow",font=("Arial",10))
#Labels
...
#deleteFrame
#Labels
deleteTLabel=tk.Label(deleteFrame,text="Delete Record In Table",font=titleFont,bg='lightblue',fg='blue')
deleteTLabel.grid(row=1,column=1,columnspan=5)
